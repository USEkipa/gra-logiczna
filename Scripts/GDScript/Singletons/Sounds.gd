...
const soundDict = {
	...
	preload("res://Resources/Soundtracks/Effects/button_click/BUTTON_CLICK.mp3"),
	...
	SoundType.PASS_THE_LEVEL:
	preload("res://Resources/Soundtracks/Effects/pass_the_level/PASS_THE_LEVEL.mp3"),
